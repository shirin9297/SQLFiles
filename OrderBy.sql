...
select * from kisiler ORDER BY adres asc; -- ASCANDING (ASC) yazmasakda sirali verir

-- kisiler tablosunu adres'e göre tersten sıralayarak sorgulayınız.
select * from kisiler ORDER BY adres desc --DESCANDING (DESC) tersten siralama yapacagimiz zaman kullaniriz.
